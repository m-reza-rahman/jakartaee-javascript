...
The project is in standard Maven format. You should be able to open it using any IDE that supports Maven and run it using any Jakarta EE 10 container. The project now uses Payara Micro for easy deployment and testing. Note that the project uses an embedded H2 database.
